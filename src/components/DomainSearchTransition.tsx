        ...
        >
            ...
            <div className={`flex flex-col items-center space-y-10 sm:space-y-12 transition-all duration-700 ${
                ...
                <div className="text-center space-y-3">
                    <p className="text-sm sm:text-base font-bold tracking-[0.2em] uppercase text-muted-beige dark:text-primary/50">
                        Dominio
                    </p>
                    <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-charcoal dark:text-primary">
                        {domain}<span className="text-muted-beige dark:text-primary/50">.eirl.pe</span>
                    </h2>
                </div>
                ...
                <div className="w-48 sm:w-64 md:w-80 h-0.5 bg-charcoal/10 dark:bg-primary/15 rounded-full overflow-hidden">
                    <div
                        className="h-full bg-charcoal dark:bg-primary rounded-full transition-all duration-700 ease-out"
                ...
                <div className="h-8 flex items-center justify-center">
                    <p
                        key={messageIndex}
                        className="text-base sm:text-lg md:text-xl text-muted-beige dark:text-primary/60 font-light animate-fadeInUp"
                    >
