      ...
      <div className="mx-auto max-w-[1440px] grid grid-cols-1 md:grid-cols-4 gap-10 sm:gap-12 md:gap-8 lg:gap-10 xl:gap-12 min-w-0">
        <div className="md:col-span-2 space-y-4 sm:space-y-6 lg:space-y-8 min-w-0">
          ...
          <div className="flex flex-wrap gap-6 sm:gap-8">
            <a
              className="text-primary/50 dark:text-primary-bright/90 hover:text-primary dark:hover:text-primary-bright transition-colors uppercase tracking-[0.2em] text-sm sm:text-base font-bold"
              href="#"
            >
              Twitter
            </a>
        ...
        <div className="space-y-4 sm:space-y-6">
          <h5 className="uppercase tracking-widest text-sm font-bold text-primary/30 dark:text-primary-bright/70">
            Oficina
          </h5>
