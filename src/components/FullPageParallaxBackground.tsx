...
export default function FullPageParallaxBackground() {
    ...
    const blob1 = useParallax<HTMLDivElement>({ speed: -12 });
    const blob2 = useParallax<HTMLDivElement>({ speed: 14 });
    const blob3 = useParallax<HTMLDivElement>({ speed: -8 });
    ...
    return (
        ...
        >
            ...
            {/* Blobs de ambiente (atrás) */}
            <div ref={blob1.ref} className="absolute -top-40 -right-40 w-[min(90vw,600px)] h-[600px] rounded-full bg-primary/30 blur-3xl" />
            <div ref={blob2.ref} className="absolute top-1/2 -left-32 w-[500px] h-[500px] rounded-full bg-muted-beige/20 blur-3xl" />
            <div ref={blob3.ref} className="absolute bottom-0 right-1/4 w-[400px] h-[400px] rounded-full bg-charcoal/[0.06] blur-3xl" />

            {/* Patrón de puntos (rápido) - muy visible */}
            <div
                ref={dotsFast.ref}
                className="absolute -top-[30%] -left-[30%] w-[160%] h-[160%] opacity-[0.24]"
                style={{ willChange: 'transform' }}
            >
                <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <pattern id="fp-dots-fast" width={DOT_SPACING} height={DOT_SPACING} patternUnits="userSpaceOnUse">
                            <circle cx={DOT_SPACING / 2} cy={DOT_SPACING / 2} r="2" fill="#171712" />
                        </pattern>
                    </defs>
                ...
                <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <pattern id="fp-dots-slow" width={DOT_SPACING * 1.4} height={DOT_SPACING * 1.4} patternUnits="userSpaceOnUse">
                            <circle cx={DOT_SPACING * 0.7} cy={DOT_SPACING * 0.7} r="1.2" fill="#171712" />
                        </pattern>
                    </defs>
                ...
                <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <pattern id="fp-lines-v" width={LINE_SPACING} height={LINE_SPACING} patternUnits="userSpaceOnUse">
                            <line x1={0} y1={0} x2={0} y2={LINE_SPACING} stroke="#171712" strokeWidth="0.6" />
                        </pattern>
                        <pattern id="fp-lines-h" width={LINE_SPACING} height={LINE_SPACING} patternUnits="userSpaceOnUse">
                            <line x1={0} y1={0} x2={LINE_SPACING} y2={0} stroke="#171712" strokeWidth="0.6" />
                        </pattern>
                    </defs>
            ...
            <div ref={circlesBack.ref} className="absolute inset-0 flex items-center justify-center overflow-visible" style={{ willChange: 'transform' }}>
                ...
                <div className="absolute top-[60%] right-[25%] w-16 h-16 rounded-full bg-charcoal/[0.06]" />
                <div className="absolute bottom-[40%] right-[12%] w-20 h-20 rounded-full border border-charcoal/10" />
            </div>

            {/* Círculos (capa al frente, más visibles) */}
            <div ref={circlesFront.ref} className="absolute inset-0 overflow-visible" style={{ willChange: 'transform' }}>
                ...
                <div className="absolute bottom-[30%] left-[35%] w-14 h-14 rounded-full bg-primary/40" />
                <div className="absolute top-[35%] left-[8%] w-10 h-10 rounded-full bg-charcoal/10" />
                <div className="absolute bottom-[15%] right-[30%] w-24 h-24 rounded-full border-2 border-charcoal/15" />
                <div className="absolute top-[80%] right-[10%] w-12 h-12 rounded-full bg-muted-beige/25" />
            </div>

            {/* Triángulos (capa 1) - clip-path para posición fácil */}
            <div ref={trianglesLayer.ref} className="absolute inset-0 overflow-visible" style={{ willChange: 'transform' }}>
                ...
                <div className="absolute top-[42%] right-[12%] w-20 h-16 bg-charcoal/[0.07]" style={{ clipPath: 'polygon(50% 100%, 0% 0%, 100% 0%)' }} />
                ...
                <div className="absolute bottom-[38%] left-[18%] w-16 h-14 bg-charcoal/[0.06]" style={{ clipPath: 'polygon(50% 100%, 0% 0%, 100% 0%)' }} />
            ...
            {/* Triángulos (capa 2, otra velocidad) */}
            <div ref={trianglesLayer2.ref} className="absolute inset-0 overflow-visible" style={{ willChange: 'transform' }}>
                ...
                <div className="absolute top-[52%] left-[4%] w-16 h-14 bg-primary/30" style={{ clipPath: 'polygon(50% 100%, 0% 0%, 100% 0%)' }} />
                ...
                <div className="absolute bottom-[12%] left-[28%] w-12 h-10 bg-charcoal/[0.05]" style={{ clipPath: 'polygon(50% 100%, 0% 0%, 100% 0%)' }} />
            ...
            {/* Velado suave para que el texto siga legible sin tapar el parallax */}
            <div className="absolute inset-0 bg-gradient-to-b from-background-light/50 via-background-light/10 to-background-light/50" />
        </div>
    );
}
