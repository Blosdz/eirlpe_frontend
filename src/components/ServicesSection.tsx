...
export default function ServicesSection() {
    ...
    return (
        <section className="py-20 sm:py-24 md:py-32 lg:py-40 px-6 sm:px-8 md:px-12 lg:px-20 transition-colors duration-500">
            <div className="mx-auto max-w-5xl lg:max-w-6xl rounded-3xl bg-background-light/90 dark:bg-charcoal/40 backdrop-blur-[2px] shadow-xl shadow-charcoal/5 dark:shadow-black/20 border border-charcoal/5 dark:border-primary/10 px-8 sm:px-10 md:px-16 lg:px-20 py-14 sm:py-16 md:py-20 lg:py-24 transition-colors duration-500">
                <div className="flex flex-col md:flex-row justify-between items-end gap-8 sm:gap-10 lg:gap-12 mb-16 sm:mb-20 lg:mb-24">
                    <div className="max-w-2xl lg:max-w-3xl space-y-4 sm:space-y-6">
                        <h3 className="text-charcoal dark:text-primary/80 uppercase tracking-[0.2em] text-sm sm:text-base font-bold">Lo que ofrecemos</h3>
                        <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-charcoal dark:text-primary leading-tight">
                            Todo lo que necesitas para tu presencia digital.
                        </h2>
                    </div>
                    <p className="max-w-sm md:max-w-md text-muted-beige dark:text-primary/70 text-lg sm:text-xl md:text-2xl font-light leading-relaxed">
