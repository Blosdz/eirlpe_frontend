...
export default function HeroSection() {
    ...
    return (
        <>
            <section className="relative flex min-h-[92vh] flex-col items-center justify-center pt-28 sm:pt-32 pb-16 px-6 sm:px-8 md:px-12 text-center">
                <div className="max-w-4xl space-y-6 sm:space-y-8 md:space-y-10 relative z-10">
                    {/* Título */}
                    <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.12] tracking-tight text-charcoal dark:text-primary transition-colors duration-500">
                    ...
                    {/* Subtítulo */}
                    <p className="mx-auto max-w-2xl text-base sm:text-lg md:text-xl text-muted-beige dark:text-primary/70 font-light leading-relaxed">
                        ...
                        <div className="w-full max-w-3xl sm:max-w-4xl mx-auto">
                            <div className="border border-charcoal/20 dark:border-primary/15 focus-within:border-accent dark:focus-within:border-accent-light rounded-2xl sm:rounded-full transition-all duration-500 bg-white/95 dark:bg-[rgba(7,5,26,0.72)] dark:backdrop-blur-md shadow-lg shadow-charcoal/10 dark:shadow-none dark:ring-1 dark:ring-primary/10 focus-within:ring-2 focus-within:ring-accent/20 dark:focus-within:ring-accent-light/25 overflow-hidden">
                                <div className="flex items-center px-4 sm:px-5 md:px-8 py-3.5 sm:py-4 md:py-5">
                                    <div className="text-charcoal/60 dark:text-primary/70 flex items-center justify-center pr-2 sm:pr-3 md:pr-4">
                                        <span className="material-symbols-outlined text-xl sm:text-2xl md:text-3xl lg:text-4xl">search</span>
                                    </div>
                                    <div className="flex items-center flex-1 text-base sm:text-xl md:text-2xl lg:text-3xl font-serif min-w-0">
                                        <span className="text-charcoal/70 dark:text-primary-bright/90 shrink-0">www.</span>
                                        <input
                                            className="flex-1 bg-transparent border-none focus:ring-0 focus:outline-none placeholder:text-charcoal/45 dark:placeholder:text-primary/60 p-0 text-charcoal dark:text-primary-bright min-w-0 mx-0.5 sm:mx-2 text-base sm:text-xl md:text-2xl lg:text-3xl font-serif"
                    ...
                    {/* Trust bar */}
                    <div className="pt-6 sm:pt-10 flex flex-wrap justify-center gap-x-6 gap-y-3 sm:gap-x-10 text-xs sm:text-sm text-muted-beige dark:text-primary/50 font-medium">
