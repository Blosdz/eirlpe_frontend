            ...
            <main className="pt-28 sm:pt-32 md:pt-36 pb-20 sm:pb-24 px-6 sm:px-8 md:px-12">
                <div className="mx-auto max-w-md">
                    <div className="text-center space-y-4 sm:space-y-5 mb-10 sm:mb-12">
                        ...
                        <p className="text-base sm:text-lg text-muted-beige dark:text-primary/90 font-light">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 px-6 py-4 sm:py-5 rounded-2xl border-2 border-charcoal/10 dark:border-primary/30 bg-white dark:bg-surface-dark hover:border-charcoal/25 dark:hover:border-primary/45 hover:shadow-md transition-all duration-300 active:scale-[0.99] disabled:opacity-60 disabled:cursor-wait"
                    >
                    ...
                    <div className="flex items-center gap-4 my-8 sm:my-10">
                        ...
                        <span className="text-xs sm:text-sm font-bold tracking-[0.15em] uppercase text-charcoal/30 dark:text-primary/60">o</span>
                        <div className="flex-1 h-px bg-charcoal/10 dark:bg-primary/20" />
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                        <div className="space-y-2">
                            <label className="block text-xs sm:text-sm font-bold tracking-[0.1em] uppercase text-charcoal/60 dark:text-primary/80">Nombre completo</label>
                            <div className="flex items-center gap-3 px-5 py-4 rounded-xl border-2 border-charcoal/10 dark:border-primary/30 bg-white dark:bg-surface-dark focus-within:border-charcoal dark:focus-within:border-primary transition-colors duration-300">
                                <span className="material-symbols-outlined text-lg text-charcoal/30 dark:text-primary/65 shrink-0">person</span>
                                <input type="text" placeholder="Juan Perez" value={form.name} onChange={handleChange('name')} className="flex-1 bg-transparent border-none focus:ring-0 p-0 text-base sm:text-lg text-charcoal dark:text-primary placeholder:text-charcoal/20 dark:placeholder:text-primary/50" />
                            </div>
                        </div>

                        <div className="space-y-2">
                            <label className="block text-xs sm:text-sm font-bold tracking-[0.1em] uppercase text-charcoal/60 dark:text-primary/80">Correo electronico</label>
                            <div className="flex items-center gap-3 px-5 py-4 rounded-xl border-2 border-charcoal/10 dark:border-primary/30 bg-white dark:bg-surface-dark focus-within:border-charcoal dark:focus-within:border-primary transition-colors duration-300">
                                <span className="material-symbols-outlined text-lg text-charcoal/30 dark:text-primary/65 shrink-0">mail</span>
                                <input type="email" placeholder="juan@empresa.com" value={form.email} onChange={handleChange('email')} className="flex-1 bg-transparent border-none focus:ring-0 p-0 text-base sm:text-lg text-charcoal dark:text-primary placeholder:text-charcoal/20 dark:placeholder:text-primary/50" />
                            </div>
                        </div>

                        <div className="space-y-2">
                            <label className="block text-xs sm:text-sm font-bold tracking-[0.1em] uppercase text-charcoal/60 dark:text-primary/80">Contraseña</label>
                            <div className="flex items-center gap-3 px-5 py-4 rounded-xl border-2 border-charcoal/10 dark:border-primary/30 bg-white dark:bg-surface-dark focus-within:border-charcoal dark:focus-within:border-primary transition-colors duration-300">
                                <span className="material-symbols-outlined text-lg text-charcoal/30 dark:text-primary/65 shrink-0">lock</span>
                                <input type={showPassword ? 'text' : 'password'} placeholder="Minimo 8 caracteres" value={form.password} onChange={handleChange('password')} className="flex-1 bg-transparent border-none focus:ring-0 p-0 text-base sm:text-lg text-charcoal dark:text-primary placeholder:text-charcoal/20 dark:placeholder:text-primary/50" />
                                <button type="button" onClick={() => setShowPassword(!showPassword)} className="text-charcoal/30 dark:text-primary/30 hover:text-charcoal/60 dark:hover:text-primary/90 transition-colors shrink-0">
                        ...
                        <div className="space-y-2">
                            <label className="block text-xs sm:text-sm font-bold tracking-[0.1em] uppercase text-charcoal/60 dark:text-primary/80">Confirmar contraseña</label>
                            <div className="flex items-center gap-3 px-5 py-4 rounded-xl border-2 border-charcoal/10 dark:border-primary/30 bg-white dark:bg-surface-dark focus-within:border-charcoal dark:focus-within:border-primary transition-colors duration-300">
                                <span className="material-symbols-outlined text-lg text-charcoal/30 dark:text-primary/65 shrink-0">lock</span>
                                <input type={showPassword ? 'text' : 'password'} placeholder="Repite tu contraseña" value={form.confirmPassword} onChange={handleChange('confirmPassword')} className="flex-1 bg-transparent border-none focus:ring-0 p-0 text-base sm:text-lg text-charcoal dark:text-primary placeholder:text-charcoal/20 dark:placeholder:text-primary/50" />
                            </div>
                    ...
                    <p className="text-center text-sm sm:text-base text-muted-beige dark:text-primary/80 mt-8 sm:mt-10">
                        Ya tienes cuenta?{' '}
