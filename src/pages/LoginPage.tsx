...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("typeof data.user.role:", typeof data.user?.role);
      console.log("================================");

      if (data.access_token && data.user) {
        // Asegurar que el user tiene la estructura correcta
        const userData = {
          ...data.user,
          role: data.user.role || "user", // Fallback a 'user' si no viene el role
        };
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="text-xs sm:text-sm text-charcoal/50 dark:text-primary-bright/85 hover:text-charcoal dark:hover:text-primary-bright transition-colors"
                >
